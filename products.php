  ...
  <main class="rf-main">
    <section class="rf-section" aria-labelledby="catalog-intro">
      <header class="rf-section-header">
        ...
        <p class="rf-section-text">Three curated categories cover bouquets, event styling, and plant gifts—each with six featured items ready for Assignment&nbsp;1 documentation.</p>
      </header>
    </section>
          ...
          <?php foreach ($category['items'] as $item): ?>
            <article class="rf-card">
              <div class="rf-card-body">
                ...
                <a class="rf-button rf-button-outline rf-button-block" href="<?php echo htmlspecialchars($ctaLink); ?>">Discuss purchase</a>
              </div>
            </article>
          <?php endforeach; ?>
        </div>
